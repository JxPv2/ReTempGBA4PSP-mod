{
  ...
  // MSG_BROWSER_HELP
  FONT_BTN_CIRCLE_GBK ":選擇   " FONT_BTN_SQUARE_GBK ":父資料夾 " FONT_UP_DIRECTORY_GBK "   " FONT_BTN_CROSS_GBK ":退出",
  ...
  FONT_BTN_CIRCLE_GBK ":執行   " FONT_CURSOR_LEFT_GBK FONT_CURSOR_RIGHT_GBK ":載入/儲存   " FONT_BTN_CROSS_GBK ":退出",
