...
static void expand_blend_c(u32 *screen_src_ptr, u16 *screen_dest_ptr, u32 start, u32 end, u16 bldcnt);
...
void update_scanline(void)
{
  ...
  if (video_mode)
  {
    affine_reference_x[0] += (s16)pIO_REG(REG_BG2PB);
    affine_reference_y[0] += (s16)pIO_REG(REG_BG2PD);
    affine_reference_x[1] += (s16)pIO_REG(REG_BG3PB);
    affine_reference_y[1] += (s16)pIO_REG(REG_BG3PD);
  }
}
